...
- Автентифікація користувачів (API ключі)
- Завантаження файлів замість вставки коду
- Збереження історії задач у базі даних
- Підтримка кількох серверів (multi-node)
- Email/webhook сповіщення про завершення задачі